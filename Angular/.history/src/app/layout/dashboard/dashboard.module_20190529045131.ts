...
import { MemeberService } from 'src/app/shared/services/memeber.service';
...
@NgModule({
    ...
    declarations: [DashboardComponent, RegisterComponent, DeleteClubComponent, NewClubComponent, UpdateClubComponent]
})
